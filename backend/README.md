...
## Project Structure
    ...
    ├── healthy_hartford_29962  # Django project configurations
...
1. Clone this repo and `cd healthy_hartford_29962`
...
2. Clone this repo and `cd healthy_hartford_29962`
